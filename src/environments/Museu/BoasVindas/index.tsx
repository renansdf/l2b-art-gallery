...
const BoasVindas: React.FC = () => {
    ...
    return (
        <a-entity id="BoasVindas" room_name="bem vindo">
            ...
            {/* <!--HotSpots--> */}
            <a-entity id="boasvindas_hotspot_01" onClick={() => handleClick(<ContentPagination contentId="YK7_dhAAACQAYEP0" />)} contentType="0" scale="0.5 0.5 1" mixin="hotspotMixin" class="collidable" position="0.05 3 -6.83"></a-entity>
            <a-entity id="boasvindas_hotspot_02" onClick={() => handleClick(<ContentPagination contentId="YK7_mhAAACQAYESU" />)} contentType="0" scale="0.5 0.5 1" mixin="hotspotMixin" class="collidable" position="3.3 3 -4.1"></a-entity>
            <a-entity id="boasvindas_hotspot_03" onClick={() => handleClick(<ContentPagination contentId="YK7_XBAAACYAYEN3" />)} contentType="0" scale="0.5 0.5 1" mixin="hotspotMixin" class="collidable" position="-3.3 3 -4.1"></a-entity> 
            {/* 
            */}
            {/* <!--HotSpots--> */}
