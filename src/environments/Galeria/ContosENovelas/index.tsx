...
const ContosENovelas: React.FC = () => {
  ...
  return (
    <a-entity id="ContosENovelas" room_name="contos & novelas">
      ...
      {/* <!--Hotspots--> */}
      <a-entity id="ContoENovelas_hotspot_01" onClick={() => handleClick(<ContentPagination contentId="YK7F4xAAACUAX0KH" />, {position:{x:-26.65, y: 5, z:-3},rotation:orientations.esquerda}, 'ContoENovelas_hotspot_01')} mixin="hotspotMixin" class="collidable" position="-26.35 4.85 -2.55"></a-entity>
      <a-entity id="ContoENovelas_hotspot_02" onClick={() => handleClick(<ContentPagination contentId="YK7NYBAAACQAX2On" />, {position:{x:-28.95, y: 5, z:-3},rotation:orientations.esquerda}, 'ContoENovelas_hotspot_02')} mixin="hotspotMixin" class="collidable" position="-28.65 4.85 -2.55"></a-entity>
      <a-entity id="ContoENovelas_hotspot_03" onClick={() => handleClick(<ContentPagination contentId="YK7NexAAACUAX2Qp" />, {position:{x:-28.95, y: 5, z:-5.8},rotation:orientations.esquerda}, 'ContoENovelas_hotspot_03')} mixin="hotspotMixin" class="collidable" position="-28.65 4.85 -6"></a-entity>
      <a-entity id="ContoENovelas_hotspot_04" onClick={() => handleClick(<ContentPagination contentId="YK7NlxAAACMAX2Sz" />, {position:{x:-26.65, y: 5, z:-5.8},rotation:orientations.esquerda}, 'ContoENovelas_hotspot_04')} mixin="hotspotMixin" class="collidable" position="-26.35 4.85 -6"></a-entity>
