...
const Infantis: React.FC = () => {
  ...
  return (
    <a-entity id="Infantis" room_name="infantis">
      ...
      {/* <!--HotSpots--> */}
      <a-entity id="infantis_hotspot_01" hotspot_collider data-art-ref="YK7jQhAAACMAX8bf" onClick={() => handleClick(<ContentGallery contentId="YK7jQhAAACMAX8bf" />, {position:{x:-10.472, y: 1.340, z:-5.200},rotation:{x: 1.5, y: 5.75, z: 0}}, 'infantis_hotspot_01')} mixin="hotspotMixin" class="collidable" position="-10.520 1.1 -5.33"></a-entity>
      <a-entity id="infantis_hotspot_02" hotspot_collider data-art-ref="YK75phAAACUAYCos" onClick={() => handleClick(<ContentGallery contentId="YK75phAAACUAYCos" />, {position:{x:-13.638, y: 1.340, z:-2.810},rotation:{x: 1.5, y: 2.5, z: 0}}, 'infantis_hotspot_02')} mixin="hotspotMixin" class="collidable" position="-13.620 1.1 -2.67"></a-entity>
      <a-entity id="infantis_hotspot_03" hotspot_collider data-art-ref="YK75vRAAACMAYCqR" onClick={() => handleClick(<ContentGallery contentId="YK75vRAAACMAYCqR" />, {position:{x:-16.337, y: 1.340, z:-5.353},rotation:{x: 1.5, y: 5.75, z: 0}}, 'infantis_hotspot_03')} mixin="hotspotMixin" class="collidable" position="-16.410 1.1 -5.2"></a-entity>
      <a-entity id="infantis_hotspot_04" hotspot_collider data-art-ref="YK751BAAACMAYCsB" onClick={() => handleClick(<ContentGallery contentId="YK751BAAACMAYCsB" />, {position:{x:-10.081, y: 1.340, z:-2.685},rotation:{x: 1.5, y: 2.5, z: 0}}, 'infantis_hotspot_04')} mixin="hotspotMixin" class="collidable" position="-10.130 1.1 -2.67"></a-entity>
